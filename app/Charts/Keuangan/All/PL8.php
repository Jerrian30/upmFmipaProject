...
namespace App\Charts\Keuangan\All;
...
class PL8
{
    ...
    {
        $dataPercentages = $this->calculatePercentages('staff_terbuka_kritik');
    ...
    {
        $dataTotal = Keuangan::selectRaw("COUNT(*) as count, $columnName")
            ->groupBy($columnName)
    ...
    public function getDetailedPercentages()
    {
        ...
        $percentages = $this->calculatePercentages('staff_terbuka_kritik');
        return [
