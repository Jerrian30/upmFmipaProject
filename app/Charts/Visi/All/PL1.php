...
class PL1
{
    ...
    {
        $data = Visi::select('mengetahui_vmts', \DB::raw('count(*) as total'))
            ->groupBy('mengetahui_vmts')
            ->pluck('total', 'mengetahui_vmts')->all();
    
        $labels = ['Sangat Mengetahui', 'Mengetahui', 'Cukup Mengetahui', 'Kurang Mengetahui', 'Tidak Mengetahui'];
