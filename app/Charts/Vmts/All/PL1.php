...
namespace App\Charts\Vmtsdata\All;
...
class PL1
{
    ...
    public function build(): \ArielMejiaDev\LarapexCharts\DonutChart
    {
        ...
        return $this->chart->donutChart()
            ...
            ->setLabels(['Tidak Mengetahui','Kurang Mengetahui', 'Cukup Mengetahui', 'Mengetahui', 'Sangat Mengetahui']);
    }

    protected function calculatePercentages($columnName): array
    {
        $dataTotal = VmtsData::selectRaw("COUNT(*) as count, $columnName")
            ->groupBy($columnName)
