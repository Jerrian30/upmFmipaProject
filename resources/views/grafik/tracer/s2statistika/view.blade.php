<div class="row">
    ...
    <div class="col-lg-3 mb-4 s2statistikaContainer" style="display: none;">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">2.	Prodi menetapkan dosen pembina/pembimbing kegiatan kemahasiswaan di s2statistikag akademik dan non akademik</h6>
                {!! $s2statis2->container() !!}
            </div>
        </div>
    </div>
