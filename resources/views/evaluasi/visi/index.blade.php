...
{{-- @include('grafik.visi.d3farmasi.js')
@include('grafik.visi.s1farmasi.js')
@include('grafik.visi.s1matematika.js')
@include('grafik.visi.s1geofisika.js')
@include('grafik.visi.d3kebidanan.js')
@include('grafik.visi.d3keperawatan.js')
@include('grafik.visi.s1statistika.js') 
@include('grafik.visi.s2statistika.js')
@include('grafik.visi.s1biologi.js')
@include('grafik.visi.d3labsains.js')
@include('grafik.visi.s1kimia.js')
@include('grafik.visi.s2kimia.js') 
@include('grafik.visi.s1fisika.js') --}}
...
<div class="row">
    <div class="container mt-1">
        ...
        {{-- @include('grafik.visi.s1matematika.view')

        @include('grafik.visi.d3keperawatan.view')
        @include('grafik.visi.d3farmasi.view')
        @include('grafik.visi.s1farmasi.view')
        @include('grafik.visi.s1fisika.view') 
        @include('grafik.visi.s1geofisika.view')
        @include('grafik.visi.s1kimia.view')
        @include('grafik.visi.s2kimia.view') 
        @include('grafik.visi.d3kebidanan.view')
        @include('grafik.visi.s1statistika.view')
        @include('grafik.visi.s2statistika.view')
        @include('grafik.visi.s1biologi.view')
        @include('grafik.visi.d3labsains.view') --}}
    </div>
</div>
@endsection