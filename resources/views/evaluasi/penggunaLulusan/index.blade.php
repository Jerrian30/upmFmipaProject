...
@include('grafik.penggunaLulusan.s2statistika.js')
...
@include('grafik.penggunaLulusan.s1farmasi.js')
@include('grafik.penggunaLulusan.s1kimia.js')
@include('grafik.penggunaLulusan.s2kimia.js') 
@include('grafik.penggunaLulusan.s1geofisika.js')
@include('grafik.penggunaLulusan.s1biologi.js')
@include('grafik.penggunaLulusan.s2biologi.js')
@include('grafik.penggunaLulusan.s1fisika.js')
...
<div class="row">
    <div class="container mt-1">
        ...
        @include('grafik.penggunaLulusan.s2statistika.view')
        ...
        @include('grafik.penggunaLulusan.s1farmasi.view')
        @include('grafik.penggunaLulusan.s1kimia.view')
        @include('grafik.penggunaLulusan.s2kimia.view') 
        @include('grafik.penggunaLulusan.s1geofisika.view')
        @include('grafik.penggunaLulusan.s1biologi.view')
        @include('grafik.penggunaLulusan.s2biologi.view')
        @include('grafik.penggunaLulusan.s1fisika.view') 
    </div>
</div>
@endsection