...
@section('title', 'Evaluasi -> Pengguna Terhadap Kinerja Layanan Subbagian Keuangan')
@section('page', 'Evaluasi -> Pengguna Terhadap Kinerja Layanan Subbagian Keuangan')
{{-- java script --}}
@section('js')

@include('grafik.keuangan.s1matematika.js')
@include('grafik.keuangan.all.js')
@include('grafik.keuangan.s1statistika.js') 
@include('grafik.keuangan.s2statistika.js')
@include('grafik.keuangan.d3keperawatan.js')
@include('grafik.keuangan.d3kebidanan.js')
@include('grafik.keuangan.d3labsains.js')
@include('grafik.keuangan.d3farmasi.js')
@include('grafik.keuangan.s1farmasi.js')
@include('grafik.keuangan.s1kimia.js')
@include('grafik.keuangan.s2kimia.js') 
@include('grafik.keuangan.s1geofisika.js')
@include('grafik.keuangan.s1biologi.js')
@include('grafik.keuangan.s2biologi.js')
@include('grafik.keuangan.s1fisika.js')
...
<div class="row">
    <div class="container mt-1">
        <a href="{{ route('keuangan.table') }}" class="btn btn-primary">Lihat Penjelasan Tiap Butir Pertanyaan</a>
        <br><br>
        ...
        @include('grafik.keuangan.s1matematika.view')
        @include('grafik.keuangan.all.view')
        @include('grafik.keuangan.s1statistika.view')
        @include('grafik.keuangan.s2statistika.view')
        @include('grafik.keuangan.d3keperawatan.view')
        @include('grafik.keuangan.d3kebidanan.view')
        @include('grafik.keuangan.d3labsains.view')
        @include('grafik.keuangan.d3farmasi.view')
        @include('grafik.keuangan.s1farmasi.view')
        @include('grafik.keuangan.s1kimia.view')
        @include('grafik.keuangan.s2kimia.view') 
        @include('grafik.keuangan.s1geofisika.view')
        @include('grafik.keuangan.s1biologi.view')
        @include('grafik.keuangan.s2biologi.view')
        @include('grafik.keuangan.s1fisika.view') 
    </div>
</div>
@endsection