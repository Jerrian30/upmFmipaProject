...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tracers', function (Blueprint $table) {
            ...
            $table->text('bulan_tahun_lulus');
            $table->string('lama_pendidikan');

            $table->string('kepemilikan_serkom');
            ...
            $table->string('jumlah_perusahaan_dilamar');
            ...
            $table->string('bulan_tahun_mulai_bekerja')->nullable();
            $table->string('masa_tunggu_mendapatkan_pekerjaan')->nullable();
            $table->string('proses_mendapatkan_pekerjaan')->nullable();
            $table->string('kapan_mulai_mencari_pekerjaan')->nullable();
            ...
            $table->string('pekerjaan_sesuai_harapan')->nullable();
            ...
            $table->text('saran_praktis_untuk_pendidikan')->nullable();
            $table->text('kompetensi_diperlukan_dalam_pekerjaan')->nullable();
